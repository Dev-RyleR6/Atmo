...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2026 at 09:59 AM
...
CREATE TABLE `notifications` (
  ...
  `type` enum('like','comment','follow','repost') NOT NULL,
...
ALTER TABLE `posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_post_date` (`created_at`);
...
ALTER TABLE `users`
  ...
  ADD KEY `idx_user_search` (`username`,`first_name`,`last_name`,`email`);
